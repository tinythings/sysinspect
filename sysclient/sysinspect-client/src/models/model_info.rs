...
impl ModelInfo {
    pub fn new(
        description: String, entity_states: std::collections::HashMap<String, Vec<Vec<serde_json::Value>>>, id: String,
        maintainer: String, name: String, version: String,
    ) -> ModelInfo {
        ModelInfo { description, entity_states, id, maintainer, name, version }
    }
}
