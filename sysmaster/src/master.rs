...
use libsysproto::{
    ...
    query::{
        SCHEME_COMMAND,
        commands::{
            CLUSTER_CMDB_UPSERT, CLUSTER_HOPSTART, CLUSTER_MASTER_LOGS, CLUSTER_MINION_HOPSTART, CLUSTER_MINION_INFO, CLUSTER_MINION_LOGS,
            CLUSTER_MINION_RECONNECT, CLUSTER_MINION_SHUTDOWN, CLUSTER_MODELS, CLUSTER_ONLINE_MINIONS, CLUSTER_PROFILE, CLUSTER_REMOVE_MINION,
